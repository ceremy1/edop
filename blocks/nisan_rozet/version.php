...
$plugin->version   = 2016121300;        // mevcut version (Date: YYYYMMDDXX)
$plugin->requires  = 2014051200;        // gerekli Moodle version 2.7.0 task api kullanıldığı için
$plugin->component = 'block_nisan_rozet';
$plugin->release = 'v2.9-r1';
$plugin->maturity = MATURITY_BETA;       //henüz beta :)88